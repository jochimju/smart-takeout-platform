...
class DishCacheMutexTest {
    ...
    void setmealConcurrentReadsUseSameMutexAndResultPayload() throws Exception {
        ...
        SetmealServiceImpl setmeals = spy(new SetmealServiceImpl(mock(com.sky.mapper.SetmealMapper.class),
                mock(com.sky.mapper.SetmealDishMapper.class), mock(com.sky.mapper.DishMapper.class),
                new com.sky.cache.MenuCache(redis, lock, metrics)));
        AtomicInteger loads = new AtomicInteger();
        doAnswer(call -> {
