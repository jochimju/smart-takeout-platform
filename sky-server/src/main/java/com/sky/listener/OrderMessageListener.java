...
public class OrderMessageListener {
    ...
    public void handleSeckillOrder(SeckillOrderMessageDTO messageDTO, Channel channel, Message message) throws IOException {
        acknowledgeAfterSuccess(channel, message, () -> setmealService.createSeckillOrder(messageDTO),
                "seckill order", messageDTO.getOrderNumber());
    }
