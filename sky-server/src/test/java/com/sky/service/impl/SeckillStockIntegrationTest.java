...
class SeckillStockIntegrationTest {
 ...
 @BeforeAll static void setup() throws Exception {
  ...
  ReflectionTestUtils.setField(target,"setmealMapper",sql.getMapper(SetmealMapper.class));ReflectionTestUtils.setField(target,"addressBookMapper",sql.getMapper(AddressBookMapper.class));
  ...
  OrderLifecycleService life=new OrderLifecycleService(sql.getMapper(OrderMapper.class),sql.getMapper(OrderDetailMapper.class),sql.getMapper(DishMapper.class),sql.getMapper(SetmealMapper.class),sql.getMapper(UserCouponMapper.class),reservations,jobs,jdbc);
